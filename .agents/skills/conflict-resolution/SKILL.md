...
description: Use whenever git merge, git rebase, or git cherry-pick results in merge conflicts (markers <<<<<<<, =======, >>>>>>>). Analyzes intent and cleanly resolves diffs while maintaining test suites.
---
