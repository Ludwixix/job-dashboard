...
ENV_VARS="HOST=0.0.0.0,ENVIRONMENT=production,JWT_SECRET_KEY=${JWT_SECRET_KEY},JOB_DASHBOARD_DATA_DIR=/app/data,JOB_DASHBOARD_GCS_DATA_BUCKET=${PROJECT_ID}-job-dashboard-data,JOB_DASHBOARD_SEEK_CACHE_PATH=/app/data/seek_cache.json,JOB_DASHBOARD_SEEK_CACHE_FALLBACK=true,JOB_DASHBOARD_SEEK_BROWSER_FALLBACK=false,JOB_DASHBOARD_STEALTH_BROWSER_ENABLED=false,JOB_DASHBOARD_SOURCE_TIMEOUT=12.0,JOB_DASHBOARD_LINKEDIN_ENABLED=false,JOB_DASHBOARD_MULTI_BOARD_ENABLED=false"
