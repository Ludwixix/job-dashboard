...
class StructuredLogger:
    ...
    def __init__(
        self, name: str, log_dir: Path | None = None, level: LogLevel = LogLevel.INFO
    ):
        """
    ...
    def _create_log_entry(
        self, level: LogLevel, msg: str, extra: dict[str, Any] | None = None
    ) -> LogEntry:
        """Create a log entry."""
        ...
        )  # Skip two frames (logger method + helper)
    ...
    def error(
        self, msg: str, extra: dict[str, Any] | None = None, exc_info: bool = False
    ):
        """Log error message."""
