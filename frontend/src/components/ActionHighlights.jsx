...
export const ActionHighlights = ({ jobs, onOpenMockInterview, onOpenInterviewPrep, onOpenOfferHub, onOpenExecutiveDossier, onSelectJob, onJobStatusUpdate, onOpenCheatSheet }) => {
 ...
 return (
 <div className="flex flex-col items-center justify-center h-96 bg-slate-900 border border-slate-800 rounded-sm">
 <div className="w-16 h-16 bg-emerald-500/10 text-emerald-400 rounded-sm flex items-center justify-center mb-4">
 ...
 <div className="p-5 rounded-sm bg-gradient-to-r from-amber-950/60 via-orange-950/40 to-slate-900 border border-amber-500/40 space-y-2">
 ...
 return (
 <div key={job.id} className="bg-slate-900 border border-slate-700/60 rounded-sm p-5 hover:border-slate-500 transition-colors flex flex-col justify-between space-y-4 relative overflow-hidden group">
 {/* Highlight Gradient strip */}
 <div className={`absolute top-0 left-0 w-1 h-full ${isInterview ? 'bg-amber-500' : isToSubmit ? 'bg-emerald-500' : 'bg-amber-500'}`} />
 
 <div>
 <div className="flex items-start justify-between mb-2">
 <span className={`px-2 py-1 rounded text-[10px] font-black uppercase tracking-wider border ${
 isInterview ? 'bg-amber-500/20 text-amber-300 border-amber-500/30' :
 ...
 className="py-2 px-3 rounded-sm bg-purple-600/20 hover:bg-purple-600/30 text-purple-400 font-bold text-xs flex items-center justify-center transition-colors cursor-pointer border border-purple-500/30"
 ...
 className="flex-1 py-2 px-3 rounded-sm bg-amber-600 hover:bg-amber-500 text-white font-bold text-xs flex items-center justify-center gap-1.5 transition-colors cursor-pointer"
 >
 <BookOpen size={14} /> Prep Guide
 </button>
 <button
 onClick={() => onOpenMockInterview(job)}
 className="flex-1 py-2 px-3 rounded-sm bg-slate-800 hover:bg-slate-700 text-amber-300 font-bold text-xs flex items-center justify-center gap-1.5 transition-colors cursor-pointer border border-amber-500/30"
 >
 ...
 className="py-2 px-3 rounded-sm bg-amber-600/20 hover:bg-amber-600/30 text-amber-300 font-bold text-xs flex items-center justify-center transition-colors cursor-pointer border border-amber-500/30"
 ...
 <button
 onClick={() => setPsychJob(job)}
 className="py-2 px-3 rounded-sm bg-teal-600/20 hover:bg-teal-600/30 text-teal-300 font-bold text-xs flex items-center justify-center transition-colors cursor-pointer border border-teal-500/30"
 ...
 className="py-2 px-3 rounded-sm bg-cyan-600/20 hover:bg-cyan-600/30 text-cyan-300 font-bold text-xs flex items-center justify-center transition-colors cursor-pointer border border-cyan-500/30"
 ...
 className="flex-1 py-2 px-3 rounded-sm bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-400 hover:to-orange-400 text-slate-950 font-black text-xs flex items-center justify-center gap-1.5 transition-all cursor-pointer"
 >
 ...
 <button
 onClick={() => onSelectJob(job)}
 className="w-full py-2 px-3 rounded-sm bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs flex items-center justify-center gap-1.5 transition-colors cursor-pointer"
 >
