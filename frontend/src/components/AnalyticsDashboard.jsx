...
export const AnalyticsDashboard = ({ jobs = [], onUpdateStatus, onSelectJob, onOpenGenerator }) => {
 ...
 <div className="bg-slate-900 border border-slate-800 rounded-sm p-5 flex flex-col justify-between font-mono">
 <div className="flex justify-between items-start mb-3">
 <div className={`p-2.5 rounded-sm bg-slate-950 border border-slate-800 text-${color}-400`}>
 <Icon size={20} />
 </div>
 </div>
 <div>
 ...
 {/* Cadence Chart */}
 <div className="lg:col-span-2 bg-slate-900 border border-slate-800 rounded-sm p-6 ">
 ...
 {/* Funnel Matrix */}
 <div className="bg-slate-900 border border-slate-800 rounded-sm p-6 flex flex-col justify-between font-mono">
 ...
 <div className="w-full bg-slate-950 rounded-sm h-2.5 overflow-hidden border border-slate-800">
 <div 
 ...
 <div className="bg-slate-900 border border-slate-800 rounded-sm p-6 space-y-4 font-mono">
 ...
 className="pl-8 pr-3 py-1.5 rounded-sm bg-slate-950 border border-slate-800 text-xs text-slate-200 placeholder-slate-600 focus:outline-none focus:border-amber-500"
 />
 </div>
 ...
 className="px-3 py-1.5 rounded-sm bg-slate-950 border border-slate-800 text-xs text-slate-300 font-bold focus:outline-none focus:border-amber-500 cursor-pointer"
 >
 ...
 <div className="font-bold text-white flex items-center gap-1.5 text-xs group-hover:text-amber-300 transition-colors">
 ...
 className={`text-[10px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-sm border focus:outline-none focus:ring-2 focus:ring-amber-500/50 appearance-none cursor-pointer ${getStatusColor(job.status)}`}
 >
 <option value="Applied">Applied (In Review)</option>
 <option value="Interviewing">Interviewing</option>
 ...
 <td className="px-4 py-3">
 {hasDocs ? (
 <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-sm bg-emerald-950/60 text-emerald-300 border border-emerald-500/40 text-[10px] font-mono font-bold">
 ...
 className="inline-flex items-center gap-1 px-2 py-0.5 rounded-sm bg-amber-950/60 text-amber-300 hover:bg-amber-900 border border-amber-500/40 text-[10px] font-mono font-bold cursor-pointer transition-colors"
 >
 ...
 type="button"
 onClick={() => onSelectJob && onSelectJob(job)}
 className="px-2.5 py-1 rounded-sm bg-amber-600/20 hover:bg-amber-600/40 text-amber-300 border border-amber-500/30 text-[10px] font-mono font-bold flex items-center gap-1 cursor-pointer transition-colors"
 ...
 className="p-1 rounded-sm bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-white inline-flex items-center gap-1 text-[10px] font-mono font-bold"
