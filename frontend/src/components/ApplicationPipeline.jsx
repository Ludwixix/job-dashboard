...
export const ApplicationPipeline = ({ 
 ...
 {/* Pipeline Toolbar */}
 <div className="flex flex-col sm:flex-row items-center justify-between gap-4 bg-slate-900 border border-slate-800 p-4 rounded-sm font-mono">
 ...
 className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-sm text-xs font-bold text-slate-400 hover:text-white hover:bg-slate-800 transition-colors cursor-pointer"
 ...
 <div className="flex bg-slate-950 p-1 rounded-sm border border-slate-800 shrink-0 font-mono text-xs font-bold">
 <button
 ...
 className="bg-slate-900/40 rounded-sm border border-slate-800 my-8"
 />
 ) : (
 <PipelineTableView 
 jobs={activeJobs} 
