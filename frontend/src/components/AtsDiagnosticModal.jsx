...
export const AtsDiagnosticModal = ({
 ...
 >
 <div className="relative w-full max-w-4xl max-h-[90vh] flex flex-col bg-slate-900 border border-slate-700/70 rounded-sm overflow-hidden text-slate-100">
 
 {/* Top Header */}
 <div className="flex items-center justify-between px-6 py-4 border-b border-slate-800 bg-slate-950/50">
 <div className="flex items-center gap-3">
 <div className="p-2 rounded-sm bg-amber-500/10 border border-amber-500/30 text-amber-400">
 <ShieldCheck size={20} />
 </div>
 <div>
 ...
 className="p-2 rounded-sm bg-slate-800 hover:bg-slate-700 text-slate-300 transition-colors cursor-pointer border border-slate-700 disabled:opacity-50"
 >
 ...
 <div className="flex items-center gap-3">
 <div className={`px-3 py-1.5 rounded-sm border font-mono font-black text-sm flex items-center gap-2 ${scoreMeta.color}`}>
 <Award size={16} />
 ...
 <RefreshCw size={28} className="animate-spin text-amber-400 mb-3" />
 ...
 <p className="text-xs font-medium text-slate-300 bg-slate-900/80 p-2.5 rounded-sm border border-slate-800">
 ...
 <div className="p-4 rounded-sm bg-slate-950/40 border border-slate-800 space-y-3">
 ...
 <div
 key={sec}
 className={`p-2.5 rounded-sm border text-center text-xs font-medium ${
 found
 ...
 className="px-3 py-1.5 rounded-sm bg-slate-800 hover:bg-slate-700 text-slate-200 border border-slate-700 text-xs font-semibold flex items-center gap-1.5 transition-colors cursor-pointer"
 >
 ...
 <div className="p-3.5 rounded-sm bg-slate-950/70 border border-slate-800 text-xs font-mono text-slate-300 space-y-2">
 ...
 <div className="p-3.5 rounded-sm bg-slate-950/40 border border-slate-800">
 ...
 <div className="p-3 rounded-sm bg-slate-900 border border-slate-800 flex items-center justify-between">
 ...
 {report.regional_au?.demographic_risks?.length > 0 && (
 <div className="p-4 rounded-sm bg-rose-950/20 border border-rose-500/30 text-rose-300 text-xs space-y-2">
 ...
 type="button"
 onClick={onClose}
 className="px-4 py-1.5 rounded-sm bg-slate-800 hover:bg-slate-700 text-slate-200 border border-slate-700 text-xs font-semibold transition-colors cursor-pointer"
 >
 Done
 </button>
 </div>
