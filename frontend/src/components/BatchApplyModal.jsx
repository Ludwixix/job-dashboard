...
export const BatchApplyModal = ({ 
 ...
 <div className="w-full max-w-4xl 2xl:max-w-5xl bg-[#14141e] border-2 border-emerald-500/50 rounded-sm overflow-hidden text-slate-100 flex flex-col max-h-[95vh]">
 
 {/* Header */}
 <div className="p-5 border-b border-[#2a2b3d] flex items-center justify-between bg-[#191926]">
 <div className="flex items-center gap-3">
 <div className="p-2.5 rounded-sm bg-gradient-to-br from-emerald-500 to-teal-600 text-white -emerald-500/20">
 ...
 <span className="text-[10px] font-bold px-2 py-0.5 rounded-sm bg-emerald-500/20 text-emerald-300 border border-emerald-500/30">
 ...
 className="text-slate-400 hover:text-white p-1.5 rounded-sm hover:bg-slate-800 transition-colors cursor-pointer disabled:opacity-30"
 >
 <X size={18} />
 </button>
 </div>
 ...
 className="px-2.5 py-1 rounded-sm bg-emerald-950/60 border border-emerald-500/40 text-emerald-300 hover:bg-emerald-900 transition-all cursor-pointer"
 >
 TOP 3
 </button>
 <button 
 ...
 <button 
 onClick={selectAll}
 className="px-2.5 py-1 rounded-sm bg-amber-950/60 border border-amber-500/40 text-amber-300 hover:bg-amber-900 transition-all cursor-pointer"
 >
 ALL ({unsubmittedJobs.length})
 </button>
 <button 
 onClick={clearSelection}
 className="px-2 py-1 rounded-sm bg-slate-800 text-slate-400 hover:text-white transition-all cursor-pointer"
 >
 CLEAR
 </button>
 </div>
 ...
 className="w-full bg-[#1e1e2d] border border-[#2f3146] rounded-sm pl-7 pr-2.5 py-1 text-xs text-white placeholder-slate-500 focus:outline-hidden focus:border-emerald-500"
 />
 </div>
 </div>
 ...
 className={`p-3 rounded-sm border flex items-center justify-between transition-all cursor-pointer select-none ${
 isSelected 
 ...
 className="w-full flex items-center justify-center gap-2.5 px-5 py-3.5 rounded-sm bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white font-black text-xs uppercase tracking-wider -emerald-500/20 transition-all cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed"
 >
 ...
 {/* Progress Track */}
 <div className="w-full bg-slate-800 rounded-sm h-2 overflow-hidden max-w-md mx-auto border border-slate-700">
 <div 
 className="bg-gradient-to-r from-emerald-500 to-teal-400 h-full transition-all duration-300 rounded-sm"
 ...
 <div className="space-y-4">
 <div className="p-3.5 rounded-sm bg-emerald-950/40 border border-emerald-500/40 flex items-center justify-between">
 ...
 <div 
 key={idx} 
 className={`p-3 rounded-sm bg-[#1a1a28] border ${
 ...
 className="flex-1 py-3 rounded-sm bg-amber-600 hover:bg-amber-700 text-white font-bold text-xs flex items-center justify-center gap-2 cursor-pointer transition-colors"
 >
 ...
 <button
 onClick={() => onClose()}
 className="flex-1 py-3 rounded-sm bg-slate-800 hover:bg-slate-700 text-white font-bold text-xs cursor-pointer transition-colors"
 >
 CLOSE BATCH AUDIT
 </button>
 </div>
