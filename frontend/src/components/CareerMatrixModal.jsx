...
export default function CareerMatrixModal({
 ...
 <div className="p-2.5 bg-amber-500/15 border border-amber-500/30 rounded-sm text-amber-400">
 ...
 <span className="px-2 py-0.5 text-xs font-semibold uppercase tracking-wider rounded-sm bg-amber-500/15 text-amber-300 border border-amber-500/30">
 Trajectory Studio
 </span>
 </div>
 ...
 className="bg-slate-800/90 text-xs text-slate-200 border border-slate-700 rounded-sm px-2.5 py-1.5 focus:outline-none focus:border-amber-500"
 >
 ...
 isTarget
 ? 'bg-amber-950/40 border-amber-500 -indigo-500/10 '
 : isCurrent
 ...
 <div
 key={i}
 className="p-4 bg-slate-800/40 border border-slate-700/70 rounded-sm flex flex-col sm:flex-row sm:items-center justify-between gap-3"
 >
 ...
 <div key={i} className="p-4 bg-slate-800/30 border border-amber-500/20 rounded-sm space-y-1.5">
 <div className="text-xs font-bold text-white">{cert.name}</div>
 <div className="text-[11px] text-amber-300 font-medium">Issuer: {cert.issuing_body}</div>
 ...
 <div
 key={idx}
 className="p-5 bg-slate-800/40 border border-slate-700/60 rounded-sm space-y-3 relative overflow-hidden"
 >
 <div className="flex items-center justify-between">
 <div className="flex items-center gap-2">
 <span className="text-xs font-black px-2.5 py-1 rounded-sm bg-amber-500/20 text-amber-300 border border-amber-500/30 uppercase tracking-wider">
 {milestone.timeframe}
 </span>
 ...
 <div className="p-5 bg-gradient-to-br from-slate-900 to-indigo-950/40 border border-amber-500/30 rounded-sm space-y-4">
 ...
 <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
 <div className="p-4 bg-slate-900/80 border border-slate-700/60 rounded-sm">
 ...
 <div className="p-4 bg-slate-900/80 border border-emerald-500/30 rounded-sm">
 ...
 <div
 key={pIdx}
 className="p-4 bg-slate-800/40 border border-slate-700/60 rounded-sm flex items-center justify-between gap-4"
 >
