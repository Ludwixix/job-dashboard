...
export const CopilotBar = ({ 
 ...
 return (
 <div className="bg-slate-900 border border-slate-800/90 rounded-sm p-3.5 flex flex-col md:flex-row items-center justify-between gap-3 ">
 <div className="flex items-center gap-3 w-full md:w-auto">
 <div className="p-2 bg-gradient-to-tr from-indigo-600 to-purple-600 rounded-sm text-white shrink-0 ">
 <Bot size={16} />
 </div>
 ...
 <span className="w-1.5 h-1.5 rounded-sm bg-emerald-400 animate-pulse" /> Active Telemetry
 </span>
 </div>
 ...
 className="px-3 py-1.5 bg-amber-600 hover:bg-amber-500 text-white font-bold text-xs rounded-sm flex items-center gap-1.5 transition-colors cursor-pointer "
 >
 ...
 className="px-3 py-1.5 bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-white font-semibold text-xs rounded-sm flex items-center gap-1.5 border border-slate-700 transition-colors cursor-pointer"
 >
 <Search size={12} />
