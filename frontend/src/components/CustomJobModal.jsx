...
export const CustomJobModal = ({ isOpen, onClose, onJobCreated, onOpenGenerator }) => {
 ...
 <div className="bg-slate-900 border border-slate-700 rounded-sm w-full max-w-2xl 2xl:max-w-3xl p-5 space-y-4 text-slate-100 max-h-[95vh] overflow-y-auto">
 <div className="flex items-center justify-between border-b border-slate-800 pb-3">
 <div className="flex items-center gap-3">
 <div className="p-2.5 rounded-sm bg-amber-500/20 text-amber-400 border border-amber-500/30">
 <Sparkles size={20} />
 </div>
 <div>
 ...
 {errorMsg && (
 <div className="p-3 bg-red-500/15 border border-red-500/30 rounded-sm flex items-start gap-2.5 text-xs text-red-300">
 ...
 <div className="p-4 bg-emerald-500/15 border border-emerald-500/30 rounded-sm flex items-start gap-3">
 ...
 className="flex-1 py-2.5 px-3 bg-slate-800 hover:bg-slate-700 text-slate-200 rounded-sm text-xs font-bold flex items-center justify-center gap-1.5 border border-slate-700 cursor-pointer"
 >
 <Download size={14} /> Resume PDF
 </button>
 <button
 onClick={() => downloadAtsDocxResume(generatedDocs.job, getActiveProfile(), generatedDocs.resume)}
 className="flex-1 py-2.5 px-3 bg-teal-800/80 hover:bg-teal-700 text-white rounded-sm text-xs font-bold flex items-center justify-center gap-1.5 border border-teal-600 cursor-pointer"
 ...
 className="flex-1 py-2.5 px-4 bg-amber-600 hover:bg-amber-500 text-white rounded-sm text-xs font-bold flex items-center justify-center gap-2 cursor-pointer "
 >
 <FileText size={14} /> Open in Document Studio
 </button>
 <button onClick={onClose} className="py-2.5 px-5 bg-slate-800 hover:bg-slate-700 text-slate-300 rounded-sm text-xs font-bold cursor-pointer">
 Done
 </button>
 </div>
 </div>
 ...
 <div className="flex gap-2 p-1 bg-slate-950 rounded-sm border border-slate-800">
 <button
 type="button"
 onClick={() => setMode('text')}
 className={`flex-1 py-2 px-3 rounded-sm font-bold text-xs flex items-center justify-center gap-1.5 transition-all cursor-pointer ${
 mode === 'text' ? 'bg-amber-600 text-white ' : 'text-slate-400 hover:text-white'
 }`}
 >
 ...
 className={`flex-1 py-2 px-3 rounded-sm font-bold text-xs flex items-center justify-center gap-1.5 transition-all cursor-pointer ${
 mode === 'link' ? 'bg-amber-600 text-white ' : 'text-slate-400 hover:text-white'
 }`}
 >
 ...
 className="w-full px-3 py-2 rounded-sm bg-slate-950 border border-slate-800 text-white focus:outline-none focus:border-amber-500 text-xs font-mono"
 />
 </div>
 ...
 className="w-full px-3 py-2.5 rounded-sm bg-slate-950 border border-slate-800 text-white focus:outline-none focus:border-amber-500 text-xs font-mono"
 />
 </div>
 ) : (
 <div>
 ...
 className="w-full px-3 py-2 rounded-sm bg-slate-950 border border-slate-800 text-white focus:outline-none focus:border-amber-500 text-xs font-mono leading-relaxed resize-y"
 />
 </div>
 )}

 <div className="flex items-center justify-between pt-3 border-t border-slate-800">
 <div className="text-[11px] font-mono text-amber-400 flex items-center gap-1.5 truncate max-w-[260px]">
 ...
 onClick={onClose}
 disabled={loading}
 className="py-2 px-4 rounded-sm bg-slate-800 hover:bg-slate-700 text-slate-300 font-bold text-xs cursor-pointer"
 >
 Cancel
 </button>
 <button
 ...
 className="py-2 px-5 rounded-sm bg-amber-600 hover:bg-amber-500 text-white font-black text-xs cursor-pointer flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
 >
