...
export default function CyberpunkAmbientMode({
 ...
 <div className="flex items-center gap-2 px-3 py-1.5 rounded-sm bg-cyan-950/80 border border-cyan-500/40 text-cyan-300 font-bold backdrop-blur-md -cyan-950/40">
 ...
 className={`flex items-center gap-2 px-3.5 py-1.5 rounded-sm border text-xs font-bold transition-all cursor-pointer backdrop-blur-md ${
 audioState.isPlaying 
 ? 'bg-cyan-950/90 text-cyan-300 border-cyan-400 -cyan-950/60' 
 ...
 className="p-2 rounded-sm bg-slate-900/80 border border-slate-700 hover:border-slate-500 text-slate-300 hover:text-white transition-colors cursor-pointer backdrop-blur-md"
 ...
 className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-sm bg-slate-800/90 hover:bg-slate-700 border border-slate-600 text-slate-200 hover:text-white transition-all cursor-pointer font-bold backdrop-blur-md"
 ...
 {showAudioControls && (
 <div className="absolute right-6 top-20 w-72 bg-slate-900/95 border border-cyan-500/30 rounded-sm p-4 backdrop-blur-xl space-y-3 font-mono text-xs z-30 animate-in fade-in slide-in-from-top-2 duration-150">
 ...
 <div className="p-4 rounded-sm bg-slate-900/60 border border-cyan-500/30 backdrop-blur-md ">
 ...
 <div className="p-4 rounded-sm bg-slate-900/60 border border-purple-500/30 backdrop-blur-md ">
 ...
 <div className="p-4 rounded-sm bg-slate-900/60 border border-emerald-500/30 backdrop-blur-md ">
 ...
 <div className="p-4 rounded-sm bg-slate-900/60 border border-amber-500/30 backdrop-blur-md ">
 ...
 className="p-3.5 rounded-sm bg-slate-900/70 hover:bg-slate-850/90 border border-slate-800 hover:border-cyan-500/60 transition-all cursor-pointer backdrop-blur-md group "
 >
