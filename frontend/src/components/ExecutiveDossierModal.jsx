...
export const ExecutiveDossierModal = ({ isOpen, onClose, job, profile }) => {
 ...
 asx_enterprise: 'bg-amber-500/10 text-amber-300 border-amber-500/30',
 ...
 mid_market: 'bg-amber-500/10 text-amber-300 border-amber-500/30'
 }[dossier.enterprise_scale] || 'bg-amber-500/10 text-amber-300 border-amber-500/30';
 ...
 <div className="relative w-full max-w-6xl 2xl:max-w-7xl rounded-sm bg-slate-900/95 border border-slate-700/60 -cyan-950/40 text-slate-100 flex flex-col max-h-[95vh] overflow-hidden">
 
 {/* Top Header Bar */}
 <div className="flex items-start justify-between p-5 border-b border-slate-800 bg-slate-950/60 relative">
 <div className="flex items-start gap-4">
 <div className="p-3 rounded-sm bg-gradient-to-br from-cyan-600/30 to-indigo-600/20 border border-cyan-500/30 text-cyan-300 ">
 ...
 <span className={`text-[11px] font-semibold px-2.5 py-0.5 rounded-sm border ${sectorBadgeColor}`}>
 {dossier.sector.toUpperCase()}
 </span>
 <span className={`text-[11px] font-semibold px-2.5 py-0.5 rounded-sm border ${scaleBadgeColor}`}>
 ...
 className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-sm bg-slate-800 hover:bg-slate-700 text-slate-200 border border-slate-700 text-xs font-semibold transition "
 ...
 <button
 onClick={handlePrint}
 className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1.5 rounded-sm bg-slate-800/80 hover:bg-slate-700/80 text-slate-300 border border-slate-700/80 text-xs font-semibold transition"
 ...
 <button
 onClick={onClose}
 className="p-1.5 rounded-sm text-slate-400 hover:text-white hover:bg-slate-800 transition ml-1"
 title="Close modal"
 >
 <X className="w-5 h-5" />
 </button>
 ...
 <div className="p-4 rounded-sm bg-gradient-to-r from-cyan-950/40 via-indigo-950/30 to-slate-900 border border-cyan-500/30 ">
 ...
 <div
 key={idx}
 className="p-3.5 rounded-sm bg-slate-800/40 border border-slate-700/50 hover:border-slate-600 transition flex items-start gap-3"
 >
 <span className="flex-shrink-0 w-6 h-6 rounded-sm bg-amber-500/10 border border-amber-500/30 text-amber-300 text-xs font-bold flex items-center justify-center mt-0.5">
 {idx + 1}
 </span>
 ...
 <div className="p-4 rounded-sm bg-slate-950/50 border border-slate-800">
 ...
 <span
 key={i}
 className="px-2.5 py-1 rounded-sm bg-slate-800 text-slate-300 text-xs font-medium border border-slate-700/80 "
 >
 {comp}
 </span>
 ))}
 ...
 {/* Hierarchy Callout */}
 <div className="p-4 rounded-sm bg-slate-950/60 border border-slate-800">
 ...
 <div
 key={idx}
 className="p-4 rounded-sm bg-slate-800/40 border border-slate-700/60 flex flex-col justify-between hover:border-cyan-500/40 transition "
 >
 <div>
 ...
 <div className="p-4 rounded-sm bg-slate-950/40 border border-slate-800 flex items-start gap-3">
 ...
 { key: 'days_31_60', badge: 'PHASE 2', color: 'border-amber-500/40 bg-amber-950/10' },
 ...
 <div
 key={key}
 className={`p-5 rounded-sm border ${color} transition hover:border-slate-600`}
 >
 ...
 <div className="space-y-3 bg-slate-950/40 p-3.5 rounded-sm border border-slate-800/60">
 <div>
 ...
 <div
 key={idx}
 className="p-4 rounded-sm bg-slate-800/40 border border-slate-700/60 hover:border-cyan-500/40 transition flex items-start justify-between gap-4 group"
 >
 <div className="flex items-start gap-3">
 <span className="flex-shrink-0 w-6 h-6 rounded-sm bg-cyan-500/10 border border-cyan-500/30 text-cyan-300 text-xs font-bold flex items-center justify-center mt-0.5">
 {idx + 1}
 </span>
 <div>
 ...
 className="flex-shrink-0 p-1.5 rounded-sm bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-white border border-slate-700 text-xs transition"
 ...
 <div className="p-5 rounded-sm bg-slate-950/60 border border-amber-500/30">
 ...
 <div key={idx} className="p-3 rounded-sm bg-slate-900 border border-slate-800 text-xs text-slate-300 flex items-start gap-2">
 ...
 <button
 onClick={handleCopyFullBriefing}
 className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-sm bg-cyan-600 hover:bg-cyan-500 text-white font-bold transition "
 >
 ...
 <button
 onClick={onClose}
 className="px-3.5 py-1.5 rounded-sm bg-slate-800 hover:bg-slate-700 text-slate-300 font-semibold transition"
 >
 DONE
 </button>
 </div>
