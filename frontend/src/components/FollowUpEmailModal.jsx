...
export const FollowUpEmailModal = ({ job, onClose, initialMode = 'followup', prefillRecruiter = null }) => {
 ...
 <div className="bg-slate-900 border-2 border-amber-500/50 rounded-sm w-full max-w-3xl 2xl:max-w-4xl max-h-[95vh] flex flex-col overflow-hidden text-slate-100">
 {/* Header */}
 <div className="p-5 border-b border-slate-800 bg-slate-950/80 flex items-center justify-between">
 <div className="flex items-center gap-3">
 <div className="p-2.5 bg-amber-500/20 text-amber-400 rounded-sm border border-amber-400/30">
 <Mail size={20} />
 </div>
 <div>
 ...
 {emailData.sector && (
 <span className="px-1.5 py-0.2 rounded bg-amber-950/80 border border-amber-500/40 text-[9px] text-amber-300">
 ...
 className={`px-3.5 py-2 rounded-sm flex items-center gap-1.5 transition-all cursor-pointer shrink-0 ${
 activeMode === 'followup'
 ...
 className="w-full px-3.5 py-2.5 rounded-sm bg-slate-950 border border-slate-800 text-slate-200 text-xs focus:outline-none focus:border-amber-500 focus:ring-1 focus:ring-amber-500"
 />
 </div>
 ...
 className="w-full p-3.5 rounded-sm bg-slate-950 border border-slate-800 text-slate-200 text-xs leading-relaxed focus:outline-none focus:border-amber-500 focus:ring-1 focus:ring-amber-500 resize-none font-mono"
 />
 </div>
 </div>
 ...
 <button
 onClick={handleCopy}
 className="w-full sm:w-auto px-4 py-2.5 rounded-sm bg-slate-800 hover:bg-slate-700 text-slate-200 font-bold text-xs flex items-center justify-center gap-2 transition-colors cursor-pointer border border-slate-700"
 >
 ...
 <a
 href={mailtoUrl}
 className="w-full sm:w-auto px-5 py-2.5 rounded-sm bg-amber-600 hover:bg-amber-500 text-white font-black text-xs flex items-center justify-center gap-2 transition-all cursor-pointer"
 >
 <Send size={15} />
