...
export default function FunnelIntelligenceModal({
 ...
 >
 <div className="bg-slate-900 border border-slate-700/70 rounded-sm max-w-5xl 2xl:max-w-7xl w-full max-h-[95vh] flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-200">
 {/* Header Bar */}
 <div className="flex items-center justify-between px-6 py-4 border-b border-slate-800 bg-slate-900/80">
 <div className="flex items-center gap-3">
 <div className="p-2.5 bg-cyan-500/15 border border-cyan-500/30 rounded-sm text-cyan-400">
 ...
 <span className="px-2 py-0.5 text-xs font-semibold uppercase tracking-wider rounded-sm bg-cyan-500/15 text-cyan-300 border border-cyan-500/30">
 Pipeline Radar
 </span>
 </div>
 ...
 className="bg-slate-800/90 text-xs text-slate-200 border border-slate-700 rounded-sm px-2.5 py-1.5 focus:outline-none focus:border-cyan-500"
 >
 ...
 <div className="p-3 bg-slate-800/40 border border-slate-800 rounded-sm">
 ...
 <span className={`text-[11px] font-semibold px-2 py-0.5 rounded-sm border ${getHealthBadgeClass(data.health_badge)}`}>
 {data.health_label}
 </span>
 </div>
 </div>
 ...
 {stalledCount > 0 && (
 <span className="ml-1 px-1.5 py-0.2 rounded-sm text-[10px] font-bold bg-rose-500/20 text-rose-300 border border-rose-500/30">
 {stalledCount}
 </span>
 )}
 </button>
 ...
 <div
 key={stage.id}
 className="p-4 bg-slate-800/40 border border-slate-700/60 rounded-sm hover:border-slate-600 transition-all"
 >
 <div className="flex items-center justify-between mb-2">
 <div className="flex items-center gap-2.5">
 <span className={`p-1.5 rounded-sm border text-xs font-semibold ${getStageColor(stage.id)}`}>
 {stage.label}
 </span>
 ...
 {/* Progress Bar */}
 <div className="w-full h-2 bg-slate-700/50 rounded-sm overflow-hidden">
 <div
 className="h-full bg-gradient-to-r from-cyan-500 to-indigo-500 transition-all duration-500 rounded-sm"
 ...
 <div className="p-4 bg-amber-950/30 border border-amber-500/30 rounded-sm space-y-3">
 ...
 <div key={i} className="p-3 bg-slate-900/60 border border-amber-500/20 rounded-sm">
 ...
 <div className="p-4 bg-slate-800/40 border border-slate-700/60 rounded-sm">
 ...
 <div className="p-4 bg-slate-800/30 border border-slate-700/50 rounded-sm space-y-2">
 ...
 {stalledCount === 0 ? (
 <div className="text-center py-12 p-6 bg-slate-800/20 border border-slate-800 rounded-sm">
 ...
 <div
 key={stalledJob.id}
 className="p-4 bg-slate-800/50 border border-slate-700/70 rounded-sm hover:border-amber-500/40 transition-all flex flex-col sm:flex-row sm:items-center justify-between gap-3"
 >
 ...
 className="px-3 py-1.5 text-xs font-semibold rounded-sm bg-slate-800 hover:bg-slate-700 text-slate-200 border border-slate-700 transition-colors"
 >
 View Job
 </button>
 )}
 ...
 className="px-3 py-1.5 text-xs font-semibold rounded-sm bg-cyan-600 hover:bg-cyan-500 text-white transition-colors"
 >
 Log Outreach
 </button>
 )}
 ...
 {/* Benchmark Table */}
 <div className="overflow-x-auto border border-slate-700/60 rounded-sm">
 ...
 <div className="p-5 bg-gradient-to-br from-slate-900 to-indigo-950/40 border border-amber-500/30 rounded-sm space-y-3">
 <div className="flex items-center gap-2 text-amber-300 text-xs font-bold uppercase tracking-wider">
 <Sparkles className="w-4 h-4 text-amber-400" />
 ...
 <div className="p-3 bg-slate-900/80 border border-amber-500/20 rounded-sm">
 ...
 <button
 onClick={onClose}
 className="px-4 py-2 text-xs font-bold text-slate-200 bg-slate-800 hover:bg-slate-700 rounded-sm transition-colors"
 >
 Close
 </button>
 </div>
