...
export const GoogleWorkspaceModal = ({ 
 ...
 <div className="bg-slate-900 border border-slate-700 w-full max-w-3xl 2xl:max-w-4xl rounded-sm overflow-hidden flex flex-col max-h-[95vh]">
 {/* Header */}
 <div className="p-6 border-b border-slate-800 bg-slate-950 flex items-center justify-between">
 <div className="flex items-center gap-3">
 <div className="p-2.5 rounded-sm bg-gradient-to-br from-emerald-500 to-teal-600 text-white ">
 <Sparkles size={22} />
 </div>
 <div>
 ...
 <div className="p-5 rounded-sm bg-gradient-to-r from-emerald-950/60 via-teal-950/40 to-slate-900 border border-emerald-500/40 space-y-2">
 ...
 {user?.spreadsheetUrl ? (
 <div className="p-5 rounded-sm bg-slate-950 border border-emerald-500/60 space-y-4">
 ...
 className="w-full py-3 px-4 rounded-sm bg-emerald-600 hover:bg-emerald-500 text-white font-black text-xs transition-all flex items-center justify-center gap-2 cursor-pointer"
 >
 ...
 className="px-3.5 py-1.5 rounded-sm bg-slate-800 hover:bg-slate-700 text-slate-200 font-bold text-xs transition-colors cursor-pointer flex items-center gap-1.5"
 >
 ...
 className="w-full py-3.5 px-4 rounded-sm bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white font-black text-xs transition-all cursor-pointer flex items-center justify-center gap-2 disabled:opacity-50"
 >
 {isCreatingSheet ? (
 <>
 ...
 className="w-full py-3.5 px-4 rounded-sm bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white font-black text-xs transition-all cursor-pointer flex items-center justify-center gap-2 disabled:opacity-50"
 >
 {isScanningGmail ? (
 <>
 <RefreshCw size={15} className="animate-spin text-amber-300" />
 ...
 {gmailSuccess && (
 <div className="p-3 rounded-sm bg-amber-950/60 border border-amber-500/40 text-amber-200 text-xs flex items-center gap-2">
 ...
 className="px-3 py-1.5 rounded-sm bg-amber-600 hover:bg-amber-500 text-white font-black text-[11px] flex items-center gap-1 -xs cursor-pointer transition-colors"
 >
 ...
 <div
 key={idx}
 className="p-3 rounded-sm bg-slate-950 border border-slate-800 hover:border-amber-400/50 transition-colors space-y-1.5"
 >
 <div className="flex items-center justify-between">
 ...
 <div className="flex items-center justify-between">
 <div className="inline-flex items-center gap-2 px-3 py-1 rounded-sm text-xs font-black bg-amber-500/20 text-amber-300 border border-amber-500/30">
 <ShieldCheck size={14} className="text-amber-400" /> GOOGLE IDENTITY & PERMISSIONS
 </div>
 {user?.email && (
 ...
 {/* Scopes Notice */}
 <div className="p-3.5 rounded-sm bg-slate-950 border border-slate-800 text-xs space-y-2 text-slate-300 font-sans">
 <div className="font-mono font-bold text-[11px] text-amber-300 flex items-center gap-1.5">
 <Lock size={12} className="text-amber-400" /> REQUESTED GOOGLE PERMISSIONS
 </div>
 ...
 {/* Status / Loading */}
 {authStatusMsg && (
 <div className="p-3 rounded-sm bg-amber-950/80 border border-amber-500/50 text-amber-200 text-xs flex items-center gap-2 animate-pulse">
 ...
 <Mail size={13} className="text-amber-400" /> YOUR GOOGLE EMAIL
 </label>
 <input
 type="email"
 required
 ...
 <div className="space-y-1.5">
 <label className="text-slate-300 font-bold flex items-center gap-1.5">
 <Sparkles size={13} className="text-amber-400" /> CANDIDATE NAME
 </label>
 <input
 type="text"
 required
 ...
 className="w-full p-2.5 rounded-sm bg-slate-950 border border-slate-800 text-white focus:border-amber-500 focus:outline-none placeholder-slate-600 font-sans text-xs"
 />
 ...
 className="w-full py-3.5 px-4 rounded-sm bg-white hover:bg-slate-100 text-slate-900 font-black text-xs border border-slate-200 transition-all cursor-pointer flex items-center justify-center gap-3 disabled:opacity-50"
 >
 {isLoadingAuth ? (
