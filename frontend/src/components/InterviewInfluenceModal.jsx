...
export default function InterviewInfluenceModal({
 ...
 <div 
 className="bg-slate-900 rounded-sm w-full max-w-4xl xl:max-w-5xl overflow-hidden border border-slate-700/60 max-h-[92vh] flex flex-col"
 ...
 <div className="p-2.5 rounded-sm bg-gradient-to-tr from-amber-500 to-indigo-600 text-white border border-amber-400/40">
 <ShieldCheck size={20} />
 </div>
 <div>
 ...
 <span className={`px-2.5 py-0.5 rounded-sm font-black text-[11px] border ${
 health.score >= 75
 ...
 className="w-full bg-slate-950 border border-slate-700 rounded-sm px-3 py-2 text-white font-bold"
 >
 ...
 className="w-full bg-slate-950 border border-slate-700 rounded-sm px-3 py-2 text-white"
 />
 </div>
 ...
 className="w-full bg-slate-950 border border-slate-700 rounded-sm px-3.5 py-2 text-white text-xs"
 />
 </div>
 ...
 className="flex-1 bg-slate-950 border border-slate-700 rounded-sm px-3.5 py-2 text-white text-xs"
 />
 <button
 type="button"
 onClick={handleAddObjection}
 className="px-4 py-2 bg-rose-950 hover:bg-rose-900 text-rose-200 border border-rose-600/50 rounded-sm font-bold text-xs cursor-pointer"
 >
 + Add
 </button>
 </div>
 ...
 <div key={i} className="flex items-center justify-between p-2.5 rounded-sm bg-rose-950/40 border border-rose-700/40 text-rose-200 text-xs">
 <div className="flex items-center gap-2">
 ...
 className="px-4 py-2 bg-slate-800 hover:bg-slate-700 text-slate-200 rounded-sm font-bold text-xs cursor-pointer"
 >
 + Add
 </button>
 </div>
 ...
 <span key={i} className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-sm bg-slate-800 text-slate-300 text-xs border border-slate-700">
 <span>{t}</span>
 <button
 type="button"
 ...
 disabled={isSaving}
 className="px-6 py-2.5 rounded-sm bg-amber-600 hover:bg-amber-500 text-white font-bold text-xs cursor-pointer flex items-center gap-2"
 >
 <ShieldCheck size={15} />
 ...
 <div className="p-4 rounded-sm bg-amber-950/40 border border-amber-500/30 text-xs text-amber-200 leading-relaxed font-sans">
 ...
 <div className="space-y-3 bg-slate-950 p-4 rounded-sm border border-slate-800 text-xs">
 <div>
 ...
 className="px-4 py-2 bg-slate-800 hover:bg-slate-700 text-white rounded-sm font-bold text-xs flex items-center gap-1.5 transition-colors cursor-pointer"
 >
 <Send size={13} />
 ...
 className="px-4 py-2 bg-amber-600 hover:bg-amber-500 text-white rounded-sm font-bold text-xs flex items-center gap-1.5 transition-colors cursor-pointer"
 >
 ...
 <div className="p-4 rounded-sm bg-emerald-950/40 border border-emerald-500/30 text-xs text-emerald-200 leading-relaxed font-sans">
 ...
 className="w-full bg-slate-950 border border-slate-700 rounded-sm px-3 py-1.5 text-white"
 />
 </div>
 <div>
 ...
 <div className="bg-slate-950 p-4 rounded-sm border border-slate-800 text-xs whitespace-pre-line text-slate-300 leading-relaxed max-h-[380px] overflow-y-auto">
 {refereeBriefing}
 </div>
 ...
 className="px-5 py-2.5 bg-emerald-600 hover:bg-emerald-500 text-white rounded-sm font-bold text-xs flex items-center gap-2 transition-colors cursor-pointer "
 >
