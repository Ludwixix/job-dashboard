...
export const JobDrawer = ({ job, isOpen, onClose, onUpdateStatus, onSaveNotes, onOpenGenerator, onOpenCheatSheet }) => {
 ...
 if (s.includes('applied')) return 'bg-amber-950/60 text-amber-400 border-amber-800/50';
 ...
 {/* Drawer */}
 <div className="fixed inset-y-0 right-0 z-50 w-full md:w-[600px] bg-slate-900 border-l border-slate-800 transform translate-x-0 transition-transform duration-300 ease-in-out flex flex-col overflow-hidden">
 ...
 className={`text-[11px] font-mono font-bold uppercase tracking-wider px-3 py-1.5 rounded-sm border focus:outline-none focus:ring-2 focus:ring-amber-500/50 appearance-none cursor-pointer ${getStatusColor(job.status)}`}
 >
 ...
 <button onClick={onClose} className="p-2 bg-slate-800 hover:bg-slate-700 text-slate-400 hover:text-white rounded-sm transition-colors cursor-pointer">
 <X size={16} />
 </button>
 </div>
 ...
 className="flex-1 flex items-center justify-center gap-2 py-2 px-3 bg-slate-800 hover:bg-slate-700 text-white font-bold rounded-sm transition-colors text-xs font-mono"
 >
 ...
 className="flex-1 flex items-center justify-center gap-1.5 py-2 px-3 bg-amber-600 hover:bg-amber-500 text-white font-bold rounded-sm transition-colors text-xs font-mono cursor-pointer "
 >
 <Zap size={13} />
 ...
 className="flex items-center justify-center gap-1.5 py-2 px-3 bg-gradient-to-r from-amber-500/20 to-orange-500/20 hover:from-amber-500/30 hover:to-orange-500/30 text-amber-300 border border-amber-500/40 rounded-sm transition-all text-xs font-mono font-bold cursor-pointer -xs active:scale-95 group/btn"
 ...
 {commute && (
 <section className="p-4 rounded-sm bg-gradient-to-br from-slate-950 via-slate-900 to-indigo-950/40 border border-slate-800 space-y-3 font-mono">
 ...
 <span className="text-[10px] px-2 py-0.2 rounded-sm bg-slate-800 text-slate-300">
 ...
 <section className="p-4 rounded-sm bg-slate-950 border border-slate-800 space-y-3 font-mono">
 <div className="flex items-center justify-between">
 ...
 className="p-1.5 rounded-sm bg-slate-800 hover:bg-slate-700 text-slate-300 text-[10px] flex items-center gap-1 cursor-pointer font-bold"
 title="Copy Document"
 >
 ...
 {/* Doc Switcher Tabs */}
 <div className="flex bg-slate-900 p-1 rounded-sm border border-slate-800 text-[11px] font-bold">
 <button
 onClick={() => setDocTab('cover_letter')}
 className={`flex-1 py-1 px-2 rounded-sm transition-colors cursor-pointer text-center ${
 docTab === 'cover_letter' ? 'bg-amber-600 text-white' : 'text-slate-400 hover:text-slate-200'
 }`}
 >
 ...
 className={`flex-1 py-1 px-2 rounded-sm transition-colors cursor-pointer text-center ${
 docTab === 'resume' ? 'bg-amber-600 text-white' : 'text-slate-400 hover:text-slate-200'
 }`}
 >
 ...
 {/* Doc Preview Content */}
 <div className="p-3.5 rounded-sm bg-slate-900/80 border border-slate-800 text-xs text-slate-200 font-sans leading-relaxed whitespace-pre-wrap max-h-72 overflow-y-auto custom-scrollbar">
 {activeDocText || (
 ...
 <div className="p-4 rounded-sm bg-amber-950/20 border border-amber-500/20 text-center space-y-2">
 ...
 className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-sm bg-amber-600 hover:bg-amber-500 text-white text-xs font-bold transition-all cursor-pointer"
 >
 <Sparkles size={13} />
 ...
 className="w-full bg-slate-950 border border-slate-700 text-slate-200 rounded-sm p-4 text-sm min-h-[120px] focus:outline-none focus:border-amber-500 resize-y custom-scrollbar font-sans"
 />
 ...
 <div className="absolute -left-1.5 top-1.5 w-3 h-3 rounded-sm bg-amber-500 ring-4 ring-slate-900" />
