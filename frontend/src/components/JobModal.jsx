...
${candidatePhone}`;
 ...
 <span className="text-[10px] font-extrabold text-amber-300 bg-slate-800 px-3 py-1 rounded-sm border border-amber-500/40 -xs pointer-events-auto cursor-pointer" onClick={() => setIsDescriptionExpanded(true)}>
