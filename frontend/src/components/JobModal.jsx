    ...
    <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-950/80 backdrop-blur-md flex items-center justify-center p-4 sm:p-6 lg:p-8 animate-in fade-in zoom-in-95 duration-200">
      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-slate-800 bg-[#080d1a] px-6 pt-2 font-mono text-xs font-bold gap-2 relative z-30 overflow-visible">
          ...
          <div className="flex items-center gap-2 overflow-x-auto scrollbar-none py-0.5 min-w-0">
            ...
            >
              ...
              MY NOTES {candidateNotes ? <span className="w-2 h-2 rounded-full bg-amber-400 ml-0.5" /> : null}
            </button>
        ...
        <div className="p-6 sm:p-8 space-y-6 overflow-y-auto flex-1 font-sans bg-[#070a13]">
          ...
          {/* TAB: CANDIDATE NOTES & ACTION SCRATCHPAD */}
          {activeTab === 'notes' && (
              ...
              <div className="p-5 rounded-2xl bg-slate-900/80 border border-slate-800 shadow-xl space-y-4">
                <div className="flex items-center justify-between border-b border-slate-800 pb-3">
                  ...
                  <div className="flex items-center gap-2 text-xs">
                    ...
                    <button
                      ...
                      className="px-3.5 py-1.5 rounded-xl bg-amber-500 hover:bg-amber-400 text-slate-950 font-black text-xs transition-all shadow-md cursor-pointer disabled:opacity-50"
                    >
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {[
                      ...
                      <button
                        ...
                        className="px-2.5 py-1 rounded-lg bg-slate-800/80 hover:bg-slate-700 text-slate-300 text-[11px] font-sans border border-slate-700 cursor-pointer transition-colors"
                      >
                        + {snippet}
                      </button>
                    ))}
                ...
                <div className="pt-2">
                  <textarea
                    ...
                    className="w-full rounded-xl bg-slate-950/80 border border-slate-700/80 p-3.5 text-xs text-slate-200 font-sans focus:outline-none focus:ring-2 focus:ring-amber-400/50 resize-y leading-relaxed"
                  />
                </div>
