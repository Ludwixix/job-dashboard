...
export const LinkedInInboundModal = ({ isOpen, onClose, job = null }) => {
 ...
 className="relative w-full max-w-4xl bg-slate-900 border border-slate-700/60 rounded-sm overflow-hidden flex flex-col my-8 animate-in fade-in duration-200"
 >
 {/* Top Gradient Border */}
 ...
 <div className="p-2.5 rounded-sm bg-amber-500/10 text-amber-400 border border-amber-500/20">
 <Search className="w-5 h-5" />
 </div>
 <div>
 <div className="flex items-center gap-2">
 <span className="text-xs font-mono font-semibold tracking-wider uppercase text-amber-400">
 Phase 21: Inbound Sourcing Radar
 </span>
 <span className="text-slate-600">•</span>
 <span className={`px-2 py-0.5 rounded-sm text-xs font-mono font-medium border flex items-center gap-1.5 ${scoreBadge.colorClass}`}>
 <span className={`w-1.5 h-1.5 rounded-sm ${scoreBadge.dotClass}`} />
 {score}% Indexability
 </span>
 </div>
 ...
 className="p-2 rounded-sm text-slate-400 hover:text-slate-200 hover:bg-slate-800 transition-colors focus:outline-none focus:ring-2 focus:ring-amber-500/50"
 >
 <X className="w-5 h-5" />
 </button>
 </div>
 ...
 <div className="bg-slate-950/60 p-4 rounded-sm border border-slate-800/80 space-y-3">
 ...
 className="w-full bg-slate-900 border border-slate-700/80 rounded-sm px-3.5 py-2.5 text-sm font-mono text-slate-200 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-amber-500/50"
 />
 </div>

 {evalResult?.has_curly_quotes_warning && (
 <div className="flex items-center gap-2 p-2.5 rounded-sm bg-amber-500/10 border border-amber-500/20 text-amber-300 text-xs">
 ...
 <div className="p-4 rounded-sm bg-slate-950/40 border border-slate-800">
 ...
 className="w-full bg-slate-950/80 border border-slate-800 rounded-sm p-3 text-xs font-mono text-slate-300 focus:outline-none focus:ring-2 focus:ring-amber-500/50"
 />
 </div>
 </div>
 )}
 ...
 <div
 key={idx}
 className="p-4 rounded-sm bg-slate-950/40 border border-slate-800/80 hover:border-amber-500/30 transition-all group"
 >
 ...
 className="px-3 py-1.5 rounded-sm bg-amber-500/10 hover:bg-amber-500/20 text-amber-400 border border-amber-500/20 text-xs font-mono font-medium flex items-center gap-1.5 transition-colors shrink-0"
 >
 ...
 className="px-3.5 py-1.5 rounded-sm bg-amber-500/10 hover:bg-amber-500/20 text-amber-400 border border-amber-500/20 text-xs font-mono font-medium flex items-center gap-1.5 transition-colors"
 >
 ...
 <div className="p-4 rounded-sm bg-slate-950/80 border border-slate-800">
 ...
 <div
 key={idx}
 className="p-4 rounded-sm bg-slate-950/50 border border-slate-800 space-y-2.5"
 >
 ...
 className="px-2.5 py-1 rounded bg-amber-500/10 hover:bg-amber-500/20 text-amber-400 border border-amber-500/20 text-xs font-mono flex items-center gap-1 transition-colors"
 >
 ...
 <div className="p-2.5 rounded-sm bg-slate-900 border border-slate-800 font-mono text-xs text-sky-300 overflow-x-auto">
 {q.query}
 </div>
 </div>
 ))}
 ...
 <button
 onClick={onClose}
 className="px-4 py-2 rounded-sm bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs font-medium font-sans transition-colors"
 >
 Close Radar
 </button>
 </div>
