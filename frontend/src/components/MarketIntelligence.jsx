...
export const MarketIntelligence = ({ jobs = [] }) => {
 ...
 {/* ── Top Header Banner ── */}
 <div className="bg-gradient-to-r from-indigo-950/60 via-slate-900 to-purple-950/60 border border-amber-500/20 rounded-sm p-6 relative overflow-hidden">
 <div className="absolute right-0 top-0 w-96 h-96 bg-amber-500/5 rounded-sm blur-3xl pointer-events-none" />
 <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
 <div>
 <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-sm bg-amber-500/10 border border-amber-400/20 text-amber-300 text-xs font-bold uppercase tracking-wider mb-2">
 ...
 <div className="flex items-center gap-4 bg-slate-900/80 border border-slate-800 p-4 rounded-sm shrink-0">
 ...
 <div className="text-center">
 <div className="text-2xl font-black text-amber-400">${Math.round(trends.avgSalary / 1000)}k</div>
 ...
 <div key={idx} className="bg-slate-900 border border-slate-800/80 rounded-sm p-4 flex flex-col justify-between">
 ...
 <div className="lg:col-span-2 2xl:col-span-3 bg-slate-900 border border-slate-800 rounded-sm p-5 space-y-4">
 ...
 {item.isOwned ? (
 <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-sm text-[10px] font-bold bg-emerald-950/60 border border-emerald-500/30 text-emerald-300">
 <CheckCircle2 size={10} /> Verified in Profile
 </span>
 ) : (
 <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-sm text-[10px] font-bold bg-amber-950/40 border border-amber-500/30 text-amber-300">
 ...
 <div 
 className={`h-1.5 rounded-sm transition-all duration-500 ${item.isOwned ? 'bg-amber-500' : 'bg-amber-500/70'}`}
 ...
 <div className="bg-slate-900 border border-slate-800 rounded-sm p-5 space-y-4 flex flex-col justify-between">
 <div>
 ...
 <div key={idx} className="p-3.5 rounded-sm bg-slate-800/50 border border-slate-700/50 space-y-1.5">
 <div className="flex items-center justify-between">
 <span className="text-xs font-black text-amber-300">{rec.skill}</span>
 <span className="text-[10px] font-bold px-2 py-0.5 bg-amber-950 border border-amber-700/40 text-amber-300 rounded">
 +15% Target
 </span>
 </div>
 ...
 <div className="p-3 bg-slate-950 rounded-sm border border-slate-800/80 text-[11px] text-slate-500 space-y-1">
