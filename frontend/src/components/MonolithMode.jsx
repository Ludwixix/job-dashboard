...
export default function MonolithMode({
 ...
 <div className="w-9 h-9 rounded-none border border-[#b87326]/60 bg-[#171410] flex items-center justify-center ">
 ...
 <span className="w-1.5 h-1.5 rounded-sm bg-[#d48b38] animate-pulse" />
 ...
 className="px-3 py-1 bg-[#2b241c] text-[#d48b38] border border-[#b87326]/40 cursor-default -xs"
 ...
 className="inline-flex items-center gap-1.5 px-3 py-1.5 border border-[#b87326]/60 hover:border-[#d48b38] bg-[#1a1612] text-[#d48b38] hover:text-[#ede6dc] text-[10px] tracking-[0.15em] font-black transition-all cursor-pointer -xs"
 ...
 className="inline-flex items-center gap-1.5 px-3 py-1.5 border border-purple-800/60 hover:border-purple-500 bg-[#160d21] text-purple-300 hover:text-white text-[10px] tracking-[0.15em] font-black transition-all cursor-pointer -xs"
 title="Recruiter & Talent Network CRM"
 >
 <Users size={11} className="text-purple-400" />
 <span>RECRUITER CRM</span>
 {overdueTouchpointCount > 0 && (
 <span className="px-1.5 py-0.2 rounded-sm bg-rose-600 text-white text-[9px] font-black">
 ...
 <span className="w-1.5 h-1.5 rounded-sm bg-[#d48b38] animate-ping" />
 {notificationMsg}
 </span>
 <button
 ...
 className="bg-[#12100d] border border-[#2e271f] hover:border-[#b87326]/60 transition-all duration-500 p-5 sm:p-7 lg:p-10 relative overflow-hidden group"
 >
 ...
 className="w-full py-4 px-6 bg-[#b87326] hover:bg-[#d48b38] text-black font-black text-xs tracking-[0.25em] uppercase transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer border border-[#d48b38]"
 >
 ...
 className="bg-[#12100d] border border-[#27211a] hover:border-[#b87326]/60 p-6 space-y-4 transition-all duration-400 cursor-pointer group relative "
 >
 ...
 type="button"
 onClick={onOpenBatchApply}
 className="py-2 px-4 bg-[#b87326] hover:bg-[#d48b38] text-black font-black text-[11px] tracking-[0.2em] uppercase transition-all flex items-center gap-2 cursor-pointer self-start sm:self-auto"
 >
 <Send size={13} />
 ...
 <div
 key={job.id || `${job.company}_${job.title}_${idx}`}
 className="bg-[#12100d] border border-[#28221b] hover:border-[#b87326]/60 p-6 space-y-4 transition-all duration-300 relative group"
 >
 <div className="flex items-start justify-between gap-3">
 <div>
 ...
 className="py-2 px-4 bg-[#1a1612] hover:bg-[#262019] text-[#d48b38] border border-[#b87326]/60 font-bold text-[11px] tracking-[0.15em] uppercase transition-all -xs flex items-center gap-2 cursor-pointer disabled:opacity-50"
 >
 ...
 <div className="bg-[#12100d] border border-[#b87326]/50 max-w-2xl w-full p-6 space-y-6 relative font-mono">
