...
export function OfferActionHubModal({ isOpen, onClose, job }) {
 ...
 >
 <div 
 className="relative w-full max-w-5xl 2xl:max-w-7xl max-h-[95vh] flex flex-col bg-slate-900 border border-slate-700/80 rounded-sm -cyan-950/40 overflow-hidden"
 onClick={e => e.stopPropagation()}
 >
 {/* Top Header */}
 <div className="flex items-center justify-between px-6 py-4 border-b border-slate-800 bg-slate-900/90">
 <div className="flex items-center gap-3">
 <div className="p-2.5 rounded-sm bg-cyan-500/10 border border-cyan-500/30 text-cyan-400">
 ...
 <button 
 onClick={onClose}
 className="p-2 text-slate-400 hover:text-white rounded-sm hover:bg-slate-800 transition"
 >
 <X className="w-5 h-5" />
 </button>
 </div>
 ...
 {/* Controls Header */}
 <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 rounded-sm bg-slate-950/60 border border-slate-800">
 <div>
 ...
 className="w-full pl-7 pr-3 py-2 bg-slate-900 border border-slate-700 rounded-sm text-white font-mono text-sm focus:outline-none focus:border-cyan-400"
 />
 </div>
 </div>
 ...
 <div className="flex items-center h-10 px-3 bg-slate-900 border border-slate-700 rounded-sm">
 ...
 className="w-full px-3 py-2 bg-slate-900 border border-slate-700 rounded-sm text-white text-xs font-mono focus:outline-none focus:border-cyan-400"
 >
 ...
 <div className="p-5 rounded-sm bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800">
 ...
 <span className={`text-xs px-2.5 py-0.5 rounded-sm font-mono font-semibold border ${
 ...
 <div className="flex items-center justify-between p-4 rounded-sm bg-cyan-950/20 border border-cyan-500/30">
 <div className="flex items-center gap-3">
 ...
 <button
 onClick={() => setActiveTab('negotiation')}
 className="px-4 py-2 bg-cyan-500 hover:bg-cyan-400 text-slate-950 font-bold text-xs rounded-sm transition flex items-center gap-1.5"
 >
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 rounded-sm bg-slate-950/60 border border-slate-800">
 <div>
 <label className="block text-xs font-mono text-slate-400 mb-1.5 uppercase">
 Negotiation Posture
 </label>
 ...
 className={`p-2 rounded-sm text-left border transition ${
 posture === item.id
 ...
 <div className="p-5 rounded-sm bg-slate-950/70 border border-slate-800 space-y-4">
 ...
 <button
 onClick={handleCopy}
 className="px-3 py-1.5 bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs rounded-sm transition flex items-center gap-1.5 font-mono"
 >
 ...
 className="px-3 py-1.5 bg-cyan-500 hover:bg-cyan-400 text-slate-950 text-xs font-bold rounded-sm transition flex items-center gap-1.5"
 >
 ...
 <pre className="text-xs text-slate-300 font-mono whitespace-pre-wrap leading-relaxed max-h-80 overflow-y-auto p-3 bg-slate-900 rounded-sm border border-slate-800">
 ...
 className="w-full p-3 bg-slate-950/70 border border-slate-700 rounded-sm text-white text-xs font-mono focus:outline-none focus:border-cyan-400 resize-none leading-relaxed"
 />
 <button
 type="button"
 onClick={() => handleScanContract()}
 disabled={isScanning || !contractText.trim()}
 className="w-full py-2.5 bg-cyan-500 hover:bg-cyan-400 disabled:opacity-50 text-slate-950 font-bold text-xs rounded-sm transition flex items-center justify-center gap-2"
 >
 <ShieldAlert className="w-4 h-4" />
 ...
 {/* Safety Score Header */}
 <div className="p-4 rounded-sm bg-slate-950/60 border border-slate-800 flex items-center justify-between">
 <div>
 ...
 <div className="p-4 rounded-sm bg-emerald-500/10 border border-emerald-500/30 text-emerald-300 text-xs flex items-center gap-2 font-mono">
 ...
 <button
 onClick={onClose}
 className="px-4 py-1.5 bg-slate-800 hover:bg-slate-700 text-white rounded-sm transition"
 >
 DONE
 </button>
 </div>
