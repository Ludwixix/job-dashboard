...
export const PipelineTableView = ({ jobs = [], onUpdateStatus, onSelectJob, onOpenCheatSheet }) => {
 ...
 return (
 <div className="w-full bg-slate-900 rounded-sm border border-slate-800 overflow-hidden flex flex-col h-full font-sans">
 ...
 className={`text-[10px] font-mono font-bold uppercase tracking-wider px-3 py-1.5 rounded-sm border focus:outline-none focus:ring-2 focus:ring-amber-500/50 appearance-none cursor-pointer ${getStatusColor(job.status)}`}
 >
 ...
 className="p-1.5 rounded-sm bg-amber-500/20 hover:bg-amber-500/30 text-amber-300 border border-amber-500/30 inline-flex items-center gap-1 text-xs cursor-pointer transition-colors"
 ...
 className="p-1.5 rounded-sm bg-slate-800 hover:bg-slate-700 text-slate-400 hover:text-white inline-flex items-center gap-1 text-xs"
