...
export default function PrimeTargetSpotlight({
 ...
 return (
 <div className="mb-3.5 rounded-sm bg-gradient-to-br from-slate-900 via-slate-900/95 to-slate-950 border border-slate-800 overflow-hidden font-sans">
 {/* Header Bar */}
 ...
 <span className="p-1.5 rounded-sm bg-amber-500/10 text-amber-400 border border-amber-500/30">
 <Target size={14} />
 </span>
 <span className="font-black tracking-wider uppercase text-amber-300">
 PRIME TARGET &amp; AUTOPILOT TELEMETRY
 </span>
 <span className="hidden sm:inline-block px-2 py-0.5 rounded-sm bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-[10px] font-bold">
 65% MATCH + 35% RECENCY
 </span>
 </div>
 ...
 className="hidden sm:flex items-center gap-1.5 px-2.5 py-1 rounded-sm bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-white border border-slate-700 text-[10px] font-bold transition-all cursor-pointer"
 ...
 <span className="text-[10px] font-mono font-black uppercase px-2 py-0.5 rounded-sm bg-amber-500/20 text-amber-300 border border-amber-500/40">
 ★ TOP OPPORTUNITY
 </span>
 {primeJob.stream && (
 ...
 <span key={idx} className="text-[11px] font-mono px-2 py-0.5 rounded-sm bg-slate-900/80 text-slate-300 border border-slate-700/60">
 {t}
 </span>
 ))}
 </div>
 ...
 className="px-3 py-1.5 rounded-sm bg-slate-800 hover:bg-slate-700 text-purple-300 border border-purple-500/40 hover:border-purple-400 flex items-center gap-1.5 transition-all cursor-pointer"
 ...
 className="px-3 py-1.5 rounded-sm bg-slate-800 hover:bg-slate-700 text-cyan-300 border border-cyan-500/40 hover:border-cyan-400 flex items-center gap-1.5 transition-all cursor-pointer"
 ...
 className="px-3 py-1.5 rounded-sm bg-emerald-950 hover:bg-emerald-900 text-emerald-300 border border-emerald-500/50 flex items-center gap-1.5 transition-all cursor-pointer ml-auto"
 ...
 <div className="bg-slate-800/40 rounded-sm p-2 border border-slate-700/50">
 ...
 className="text-slate-400 hover:text-white p-1 rounded-sm hover:bg-slate-800 cursor-pointer"
 >
 ✕
 </button>
 </div>
 ...
 <div className="p-3 bg-slate-950/80 rounded-sm border border-slate-800 space-y-2 font-sans">
 ...
 className="px-3 py-1.5 rounded-sm bg-purple-600 hover:bg-purple-500 text-white font-bold cursor-pointer"
 >
 OPEN IN FULL GENERATOR
 </button>
 <button
 onClick={() => setActiveModal(null)}
 className="px-3 py-1.5 rounded-sm bg-slate-800 hover:bg-slate-700 text-slate-300 font-bold cursor-pointer"
 >
 CLOSE
 </button>
 </div>
