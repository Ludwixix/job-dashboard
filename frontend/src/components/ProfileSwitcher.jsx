...
export const ProfileSwitcher = ({ activeProfile, onProfileChange, onOpenProfileModal, onOpenSettings }) => {
 ...
 className="flex items-center gap-2.5 px-3 py-1.5 rounded-sm bg-slate-900/90 hover:bg-slate-800 border border-slate-700/80 hover:border-amber-500/80 transition-all cursor-pointer group"
 title="Your Logged-in Candidate Profile & Settings"
 >
 <div className="w-7 h-7 rounded-sm bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 text-white font-black text-xs flex items-center justify-center -xs">
 {getInitials(profile?.name)}
 </div>
 
 <div className="text-left hidden sm:block">
 <div className="text-[11px] font-black text-white group-hover:text-amber-300 transition-colors flex items-center gap-1.5 leading-tight">
 ...
 {isOpen && (
 <div className="absolute right-0 mt-2 w-84 rounded-sm bg-slate-900 border border-slate-700 z-50 p-3 space-y-3 animate-in fade-in slide-in-from-top-2 duration-150 text-xs">
 {/* Header Strip */}
 ...
 <span className="text-[9px] font-bold px-2 py-0.5 rounded-sm bg-emerald-500/20 text-emerald-300 border border-emerald-400/30">
 100% PERSISTED
 </span>
 </div>

 {/* User Dossier Summary Card */}
 <div className="p-3 rounded-sm bg-slate-950/80 border border-slate-800 space-y-2">
 <div className="flex items-start gap-2.5">
 <div className="w-9 h-9 rounded-sm bg-gradient-to-br from-indigo-600 to-purple-600 text-white font-black text-sm flex items-center justify-center shrink-0 ">
 {getInitials(profile?.name)}
 </div>
 ...
 <div className="text-[11px] text-amber-300 font-semibold truncate leading-tight mt-0.5">
 {profile?.title}
 </div>
 ...
 <div className="p-2.5 rounded-sm bg-slate-950 border border-slate-800 space-y-1 text-slate-300">
 ...
 className="w-full py-2 px-3 rounded-sm bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white font-black text-xs flex items-center justify-center gap-2 transition-all cursor-pointer"
 >
 ...
 className="w-full py-2 px-3 rounded-sm bg-slate-800/80 hover:bg-slate-700/80 text-slate-300 hover:text-white font-bold text-xs flex items-center justify-center gap-2 border border-slate-700/70 transition-all cursor-pointer"
 >
