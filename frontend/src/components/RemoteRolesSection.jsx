...
export const RemoteRolesSection = ({ 
 ...
 <div className="relative overflow-hidden rounded-sm bg-gradient-to-br from-slate-900 via-slate-900/90 to-indigo-950/40 border border-slate-800 p-6 sm:p-8 backdrop-blur-xl">
 <div className="absolute top-0 right-0 w-96 h-96 bg-teal-500/10 rounded-sm blur-3xl pointer-events-none -mr-20 -mt-20" />
 
 <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
 <div className="space-y-2">
 <div className="inline-flex items-center gap-2 px-3 py-1 rounded-sm bg-teal-950/80 border border-teal-500/30 text-teal-300 text-xs font-mono font-bold tracking-wider uppercase">
 ...
 <div className="p-3 rounded-sm bg-slate-800/80 border border-slate-700/60 flex flex-col">
 ...
 <div className="p-3 rounded-sm bg-slate-800/80 border border-slate-700/60 flex flex-col">
 <span className="text-[10px] uppercase text-amber-400 font-bold">Worldwide</span>
 <span className="text-xl font-black text-amber-300">{telemetry.globalCount}</span>
 </div>
 <div className="p-3 rounded-sm bg-slate-800/80 border border-slate-700/60 flex flex-col">
 ...
 className="w-full bg-slate-950/80 border border-slate-700 text-slate-200 rounded-sm pl-10 pr-4 py-2.5 text-xs focus:outline-none focus:border-teal-500 focus:ring-1 focus:ring-teal-500/50 transition-all placeholder-slate-600"
 />
 </div>

 <div className="flex flex-wrap items-center gap-2 w-full lg:w-auto">
 {/* Region Toggle */}
 <div className="inline-flex rounded-sm bg-slate-950 p-1 border border-slate-800">
 <button
 type="button"
 onClick={() => setRegionFilter('all')}
 className={`px-3 py-1.5 rounded-sm font-bold text-xs transition-all cursor-pointer ${regionFilter === 'all' ? 'bg-teal-600 text-white -xs' : 'text-slate-400 hover:text-white'}`}
 >
 ALL ({telemetry.total})
 </button>
 <button
 ...
 className={`px-3 py-1.5 rounded-sm font-bold text-xs transition-all cursor-pointer ${regionFilter === 'au' ? 'bg-teal-600 text-white -xs' : 'text-slate-400 hover:text-white'}`}
 >
 ...
 className={`px-3 py-1.5 rounded-sm font-bold text-xs transition-all cursor-pointer ${regionFilter === 'global' ? 'bg-teal-600 text-white -xs' : 'text-slate-400 hover:text-white'}`}
 >
 ...
 className={`flex items-center gap-1.5 px-3 py-2 rounded-sm border text-xs font-bold transition-all cursor-pointer ${minSalaryFilter ? 'bg-amber-950/60 border-amber-500/50 text-amber-300' : 'bg-slate-900 border-slate-800 text-slate-400 hover:text-white'}`}
 >
 <DollarSign size={13} />
 $130k+
 </button>
 ...
 className="bg-slate-900/40 rounded-sm border border-slate-800 my-8 p-12"
 />
 ) : (
 ...
 className="group relative flex flex-col justify-between p-5 rounded-sm bg-slate-900/80 border border-slate-800 hover:border-teal-500/60 hover:bg-slate-850 hover: hover:-teal-950/20 transition-all duration-300 cursor-pointer select-none"
 >
 <div className="space-y-3">
 {/* Top Badges */}
 <div className="flex items-center justify-between gap-2">
 <div className="flex items-center gap-1.5">
 <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-sm text-[10px] font-mono font-bold bg-teal-950/90 text-teal-300 border border-teal-500/30">
 <Wifi size={10} className="animate-pulse" />
 100% REMOTE
 </span>
 {isAu && (
 <span className="inline-flex items-center px-2 py-0.5 rounded-sm text-[10px] font-mono font-bold bg-amber-950/80 text-amber-300 border border-amber-500/30">
 AU/APAC
 </span>
 )}
 </div>
 ...
 className="flex items-center gap-1 px-2.5 py-1 rounded-sm bg-amber-600/20 hover:bg-amber-600 text-amber-300 hover:text-white border border-amber-500/30 transition-all font-bold cursor-pointer"
 ...
 className="flex items-center gap-1 px-2.5 py-1 rounded-sm bg-amber-500/20 hover:bg-amber-500 text-amber-300 hover:text-slate-950 border border-amber-500/30 transition-all font-bold cursor-pointer"
 ...
 className="p-1 rounded-sm bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-white border border-slate-700 transition-colors"
