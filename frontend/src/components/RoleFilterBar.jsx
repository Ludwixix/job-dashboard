...
export const RoleFilterBar = ({
 ...
 return (
 <div className="bg-[#0f172a]/95 backdrop-blur-md rounded-sm border border-slate-800 overflow-hidden font-mono transition-all">
 {/* Pinned Primary Bar */}
 <div className="p-3.5 sm:p-4 flex flex-col gap-3">
 <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5">
 {/* Header & Status */}
 <div className="flex items-center gap-2.5 min-w-0">
 <div className="p-2 rounded-sm bg-amber-500/15 text-amber-400 border border-amber-500/30 shrink-0">
 <Bot size={15} />
 </div>
 ...
 className="px-2.5 py-1.5 rounded-sm bg-amber-600/25 hover:bg-amber-600/40 text-amber-200 border border-amber-500/40 text-[10px] font-bold transition-all cursor-pointer flex items-center gap-1 active:scale-95"
 ...
 className="px-2.5 py-1.5 rounded-sm bg-slate-800/80 hover:bg-slate-700 text-slate-300 border border-slate-700/80 text-[10px] font-bold transition-all cursor-pointer flex items-center gap-1 active:scale-95"
 ...
 type="button"
 onClick={onSelectAll}
 className={`px-2.5 py-1.5 rounded-sm text-[10px] font-bold border transition-all cursor-pointer active:scale-95 ${
 isAllSelected 
 ...
 className="px-2 py-1.5 rounded-sm bg-slate-800/80 hover:bg-slate-700 text-slate-400 hover:text-slate-200 border border-slate-700/80 text-[10px] font-bold transition-all cursor-pointer active:scale-95"
 ...
 className="px-2.5 py-1.5 rounded-sm bg-emerald-950/40 hover:bg-emerald-900/40 text-emerald-300 border border-emerald-600/40 text-[10px] font-bold transition-all cursor-pointer flex items-center gap-1 active:scale-95"
 ...
 className="px-2.5 py-1.5 rounded-sm bg-slate-800 hover:bg-slate-700 text-slate-200 border border-slate-600 text-[10px] font-bold transition-all cursor-pointer flex items-center gap-1 active:scale-95"
 ...
 className={`px-2.5 py-1 rounded-sm border text-[11px] font-medium shrink-0 flex items-center gap-1.5 cursor-pointer transition-all active:scale-95 ${
 isSelected
 ? 'bg-amber-600/25 border-amber-500/70 text-amber-100 '
 : 'bg-slate-900/70 border-slate-800 text-slate-400 hover:border-slate-700 hover:text-slate-300'
 }`}
 >
 <span className={`w-2 h-2 rounded-sm ${isSelected ? 'bg-amber-400' : 'bg-slate-600'}`} />
 ...
 isSelected ? 'bg-amber-900/60 text-amber-200' : 'bg-slate-800 text-slate-400'
 }`}>
 {role.count}
 </span>
 </button>
 ...
 className="w-full pl-9 pr-8 py-2 rounded-sm bg-slate-900/90 border border-slate-800 text-xs text-slate-200 placeholder-slate-500 focus:outline-none focus:border-amber-500 transition-colors"
 />
 {searchTerm && (
 <button
 type="button"
 ...
 return (
 <div key={domain} className="p-3 rounded-sm bg-slate-900/60 border border-slate-800/70 space-y-2.5">
 {/* Domain Header */}
 ...
 className={`p-2 rounded-sm border text-xs flex items-center justify-between gap-2 cursor-pointer transition-all select-none w-full text-left ${
 isSelected
 ? 'bg-amber-950/50 border-amber-500/60 text-amber-100 ring-1 ring-amber-500/30'
 ...
 isSelected ? 'bg-amber-600 text-white' : 'bg-slate-800 text-transparent border border-slate-700'
 }`}>
 {isSelected ? '✓' : ''}
 </div>
 ...
 <span className={`px-1.5 py-0.5 rounded-sm text-[10px] font-mono font-bold ${
 isSelected 
 ...
 <div className="bg-slate-900 border border-slate-800 rounded-sm p-5 max-w-md w-full space-y-4 ">
 ...
 className="w-full px-3 py-2 rounded-sm bg-slate-950 border border-slate-800 text-xs text-slate-200 placeholder-slate-600 focus:outline-none focus:border-amber-500"
 />
 </div>
 ...
 className="w-full px-3 py-2 rounded-sm bg-slate-950 border border-slate-800 text-xs text-slate-200 focus:outline-none focus:border-amber-500"
 >
 {ROLE_DOMAINS.map(d => (
 ...
 type="button"
 onClick={() => setShowAddModal(false)}
 className="px-3 py-1.5 rounded-sm text-xs text-slate-400 hover:text-slate-200 border border-slate-800"
 >
 Cancel
 </button>
 <button
 type="submit"
 className="px-4 py-1.5 rounded-sm text-xs font-bold bg-emerald-600 hover:bg-emerald-500 text-white active:scale-95 transition-all"
 >
 Save &amp; Target Role
 </button>
 </div>
