...
export class SafeErrorBoundary extends React.Component {
 ...
 if (isCompact) {
 return (
 <div className="p-3 rounded-sm bg-slate-900/90 border border-amber-500/40 text-slate-300 font-mono text-xs flex items-center justify-between gap-3 ">
 ...
 return (
 <div className="p-6 rounded-sm bg-slate-900 border border-amber-500/40 my-4 text-center max-w-lg mx-auto font-sans">
 <div className="w-12 h-12 rounded-sm bg-amber-500/20 text-amber-400 flex items-center justify-center mx-auto mb-4 border border-amber-500/30">
 ...
 <button
 onClick={this.handleReset}
 className="px-5 py-2.5 rounded-sm bg-amber-600 hover:bg-amber-500 text-white font-black text-xs transition-all flex items-center gap-2 mx-auto cursor-pointer "
 >
 <RefreshCw size={14} />
