...
export default function SiteGate({ onUnlock = () => {} }) {
 ...
 <div className="w-12 h-12 border border-[#b87326]/70 bg-[#16120e] flex items-center justify-center -[0_0_20px_rgba(184,115,38,0.3)]">
 ...
 <div className="bg-[#12100d] border border-[#2e271f] p-6 sm:p-8 space-y-6 relative">
 ...
 className="w-full py-3.5 px-6 bg-[#b87326] hover:bg-[#d48b38] disabled:opacity-50 text-black font-black text-xs tracking-[0.25em] uppercase transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer border border-[#d48b38]"
 >
