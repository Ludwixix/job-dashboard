...
export default function WorkforceAustraliaModal({
 ...
 className="relative w-full max-w-5xl 2xl:max-w-6xl max-h-[95vh] flex flex-col rounded-sm bg-slate-900 border border-slate-800 overflow-hidden font-sans text-slate-100"
 >
 {/* Header */}
 <div className="flex items-center justify-between px-6 py-4 border-b border-slate-800/80 bg-slate-950/60">
 <div className="flex items-center gap-3">
 <div className="w-9 h-9 rounded-sm bg-amber-500/15 border border-amber-500/30 flex items-center justify-center text-amber-400">
 <Award size={20} />
 </div>
 <div>
 <div className="flex items-center gap-2">
 <h2 className="text-base font-black text-white tracking-tight">Workforce Australia Hub</h2>
 <span className="text-[10px] uppercase font-bold tracking-wider px-2 py-0.5 rounded-sm bg-amber-500/20 text-amber-300 border border-amber-500/30">
 ...
 <div className="flex items-center gap-2">
 <div className="flex items-center bg-slate-950 border border-slate-800 rounded-sm p-0.5 text-xs font-mono">
 <button
 type="button"
 ...
 <div className="p-5 rounded-sm bg-slate-950/80 border border-slate-800 space-y-4">
 ...
 <span className={`text-xs font-mono font-bold px-2.5 py-0.5 rounded-sm border ${
 pbas.isMet 
 ...
 className="flex items-center gap-1.5 px-3.5 py-2 rounded-sm bg-amber-500 text-slate-950 font-bold text-xs hover:bg-amber-400 transition-all cursor-pointer disabled:opacity-40"
 >
 ...
 disabled={pbas.totalEvidenceItems === 0}
 className="flex items-center gap-1.5 px-3.5 py-2 rounded-sm bg-slate-800 hover:bg-slate-700 text-slate-200 font-mono text-xs transition-all border border-slate-700 cursor-pointer disabled:opacity-40"
 >
 ...
 {pbas.items.length === 0 ? (
 <div className="p-8 rounded-sm bg-slate-950/40 border border-dashed border-slate-800 text-center space-y-2">
 ...
 <div className="overflow-x-auto rounded-sm border border-slate-800 bg-slate-950/60 ">
 ...
 className="inline-flex items-center gap-1 px-2 py-1 rounded-sm bg-slate-800 hover:bg-slate-700 text-slate-300 font-mono text-[11px] transition-colors cursor-pointer"
 ...
 <div className="p-4 rounded-sm bg-amber-500/10 border border-amber-500/20 space-y-1">
 ...
 <div key={item.id} className="p-4 rounded-sm bg-slate-950/80 border border-slate-800 space-y-3 flex flex-col justify-between">
 ...
 <div className="text-[11px] font-mono text-slate-400 space-y-0.5 bg-slate-900/60 p-2.5 rounded-sm border border-slate-800">
 ...
 <button
 onClick={() => handleCopyText(item)}
 className={`w-full py-2 px-3 rounded-sm font-mono text-xs font-bold transition-all flex items-center justify-center gap-1.5 cursor-pointer ${
 copiedId === item.id
 ...
 <div className="p-4 rounded-sm bg-slate-950/80 border border-slate-800 space-y-4">
 ...
 className="w-full bg-slate-900 border border-slate-700 rounded-sm px-3 py-2 text-white font-mono text-xs focus:outline-none focus:border-amber-500"
 />
