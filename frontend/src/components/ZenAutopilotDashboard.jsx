...
export default function ZenAutopilotDashboard({
 ...
 <div className="w-8 h-8 rounded-sm bg-gradient-to-tr from-teal-500 to-cyan-400 flex items-center justify-center -teal-500/20">
 <Sparkles className="w-4 h-4 text-slate-950" />
 </div>
 <div>
 <div className="flex items-center gap-2">
 <h1 className="text-sm font-semibold tracking-wide text-slate-100">AUTOPILOT</h1>
 <span className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-sm text-[10px] font-medium bg-emerald-950/80 text-emerald-400 border border-emerald-800/60">
 ...
 className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1.5 rounded-sm text-xs font-medium bg-slate-900 hover:bg-slate-800 text-slate-300 border border-slate-700/60 transition-colors disabled:opacity-50"
 ...
 className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-sm text-xs font-semibold bg-emerald-950/80 hover:bg-emerald-900 text-emerald-300 border border-emerald-500/40 transition-all hover:border-emerald-400/60 cursor-pointer"
 ...
 className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-sm text-xs font-semibold bg-[#1a1612] hover:bg-[#251f18] text-[#d48b38] border border-[#b87326]/40 transition-all hover:border-[#b87326]/60 cursor-pointer tracking-wider"
 ...
 className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-sm text-xs font-semibold bg-slate-800 hover:bg-slate-700 text-teal-300 border border-teal-500/30 transition-all hover:border-teal-400/50"
 >
 ...
 exit={{ opacity: 0, y: -10 }}
 className="p-3 rounded-sm bg-teal-950/80 border border-teal-500/40 text-teal-200 text-xs font-medium flex items-center justify-between "
 >
 <div className="flex items-center gap-2">
 ...
 <section className="relative overflow-hidden rounded-sm bg-gradient-to-br from-slate-900 via-slate-900/90 to-slate-950 border border-slate-800 p-6 sm:p-8 ">
 <div className="absolute top-0 right-0 w-96 h-96 bg-teal-500/5 rounded-sm blur-3xl pointer-events-none" />
 ...
 <div className="p-4 rounded-sm bg-slate-950/60 border border-slate-800/80 space-y-1.5">
 ...
 <span className="px-2 py-0.5 rounded-sm text-[10px] font-bold bg-teal-950 text-teal-300 border border-teal-800/80">
 Auto-Tailored
 </span>
 </h2>
 ...
 className="group relative rounded-sm bg-slate-900/90 hover:bg-slate-900 border border-slate-800 hover:border-slate-700/80 p-5 transition-all flex flex-col justify-between cursor-pointer"
 >
 ...
 <span className="inline-flex items-center gap-1 text-[11px] font-medium px-2 py-0.5 rounded-sm bg-slate-950 text-emerald-400 border border-slate-800">
 <Sparkles className="w-3 h-3" /> Bespoke Resume Ready
 </span>
 <span className="inline-flex items-center gap-1 text-[11px] font-medium px-2 py-0.5 rounded-sm bg-slate-950 text-cyan-400 border border-slate-800">
 ...
 className="px-2.5 py-1.5 rounded-sm text-xs font-medium bg-slate-800 hover:bg-slate-700 text-slate-200 transition-colors flex items-center gap-1.5"
 ...
 className="px-2.5 py-1.5 rounded-sm text-xs font-medium bg-emerald-950/70 hover:bg-emerald-900/80 text-emerald-300 border border-emerald-800/60 transition-colors flex items-center gap-1"
 >
 ...
 rel="noopener noreferrer"
 onClick={(e) => e.stopPropagation()}
 className="p-1.5 rounded-sm bg-teal-500 hover:bg-teal-400 text-slate-950 transition-colors"
 ...
 <div className="rounded-sm bg-slate-900/60 border border-slate-800 divide-y divide-slate-800/60">
 {activeApps.map((app) => (
 ...
 <div className="flex items-center gap-2">
 <span className="px-2.5 py-1 rounded-sm text-[11px] font-medium bg-slate-800 text-slate-300 border border-slate-700/60">
 {app.status || 'Applied'}
 </span>
 {onOpenMockInterview && (
 <button
 onClick={() => onOpenMockInterview(app)}
 className="px-2.5 py-1 rounded-sm text-xs font-medium bg-cyan-950 text-cyan-300 border border-cyan-800/60 hover:bg-cyan-900/80 transition-colors"
 >
 Simulate Interview
 </button>
 )}
 ...
 <section className="rounded-sm bg-slate-900/40 border border-slate-800/60 overflow-hidden">
 <button
 ...
 className="w-full max-w-2xl max-h-[85vh] overflow-y-auto rounded-sm bg-slate-900 border border-slate-800 p-6 space-y-4 "
 >
 ...
 <div className="p-3 rounded-sm bg-slate-950 border border-slate-800 font-mono text-[11px] text-slate-300 whitespace-pre-wrap max-h-48 overflow-y-auto">
 {activeModal.resume}
 </div>
 </div>
 ...
 <button
 onClick={() => setActiveModal(null)}
 className="px-4 py-2 rounded-sm bg-slate-800 hover:bg-slate-700 text-xs font-semibold text-slate-200"
 >
 Close
 </button>
 </div>
